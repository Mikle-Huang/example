package com.gao.thinking.proxy.concurrency.Simulation.restaurant;

import com.gao.thinking.proxy.util.Enums;
...
class Customer implements Runnable {
    ...
    public Customer(WaitPerson w) { waitPerson = w; }//一个用户一个服务员
...
// Blocks until a course is ready
                ...
                plate.getOrder().getCustomer().deliver(plate);//服务员交给客户
            }
        } catch(InterruptedException e) {
...
// Time to prepare order:
                ...
                order.getWaitPerson().filledOrders.put(plate);//厨师交给服务员
            }
        } catch(InterruptedException e) {
            System.out.println(this + " interrupted");
        }
...
public class RestaurantWithQueues {
    public static void main(String[] args) throws Exception {
        ...
        if(args.length > 0) // Optional argument
            ...
            System.out.println("Press ‘Enter’ to qu" +
                    "it");
            System.in.read();
        }
        exec.shutdownNow();
